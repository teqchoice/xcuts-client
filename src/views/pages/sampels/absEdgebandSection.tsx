      ...
      <section>
        <div className='px-4 sm:container'>
          <div className='text-center text-black mb-11 mt-20'>
            ...
            <h4 className='md:text-[40px] text-2xl font-semibold mb-7'>Our Trendy Collection Decors!</h4>
          ...
          <div className='bg-neutral-100 md:flex mb-6'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>Egger</h2>
                <p className='text-lg'>
                  Every piece of decor from the 2020–22 collection is included in the Egger swatch book. For designers
                  and cabinet makers, it is truly an essential tool!
                </p>
          ...
          <div className='bg-neutral-100 md:flex mb-6'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>Kronospan</h2>
                <p className='text-lg'>
                  A unified assortment of decors for the furniture and interior design industries is displayed in the
                  Kronospan swatch book, which mainly features the current Global collection.
                </p>
                <a href='#' className='text-lg font-semibold text-primary'>
                  Details – Purchase »{' '}
                </a>
          ...
          <div className='bg-neutral-100 md:flex mb-6'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>XyloCleaf</h2>
                <p className='text-lg'>
                  The complete selection of decors currently offered in the UK is shown in the XyloCleaf swatch book. It
                  is the ideal guide for any designer.
                </p>
                <a href='#' className='text-lg font-semibold text-primary'>
                  Details – Purchase »{' '}
                </a>
          ...
          <div className='bg-neutral-100 md:flex'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>Saviola</h2>
                <p className='text-lg'>
                  The Saviola swatch book presents a limited-edition, highly fashionable Italian interior design and
                  decor line that is accessible in the UK.
                </p>
                <a href='#' className='text-lg font-semibold text-primary'>
                  Details – Purchase »{' '}
                </a>
          ...
          <div className='bg-neutral-100 md:flex mb-6'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>Swiss Krono</h2>
                <p className='text-lg'>
                  The One World Collection’s Swiss Krono swatch book features every Swiss Krono décor option available
                  in the UK.
                </p>
                <a href='#' className='text-lg font-semibold text-primary'>
                  Details – Purchase »{' '}
          ...
          <div className='bg-neutral-100 md:flex'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>Senoplast</h2>
                <p className='text-lg'>
                  The Senoplast swatch book features a decor line of ultra-matt, high-gloss acrylic finishes in
                  fashionable hues.
                </p>
                <a href='#' className='text-lg font-semibold text-primary'>
                  Details – Purchase »{' '}
          ...
          <div className='bg-neutral-100 md:flex mb-6'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>Serica</h2>
                <p className='text-lg'>
                  The Serica swatch book offers a selection of ultra-matt finishes in fashionable hues that are
          ...
          <div className='bg-neutral-100 md:flex'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>Alvic</h2>
                <p className='text-lg'>
                  Both volumes of the Alvic swatch books contain generously sized swatches that display the complete
                  decor line.
                </p>
                <a href='#' className='text-lg font-semibold text-primary'>
                  Details – Purchase »{' '}
          ...
          <div className='bg-neutral-100 md:flex mb-6'>
            ...
            <div className='basis-[47.88%] flex items-center'>
              <div className='flex flex-col md:justify-center md:ml-auto pb-16 py-8 px-8 md:max-w-[410px] lg:max-w-[567px]'>
                <p className='text-lg md:text-xl text-black font-normal'>Décor Manual</p>
                <h2 className='text-2xl md:text-3xl text-black font-bold mb-6'>Spray Coats</h2>
                <p className='text-lg'>
                  A gorgeously crafted box with eight samples in various spray coating options—a marketing tool that is
                  essential.
                </p>
                <a href='#' className='text-lg font-semibold text-primary'>
                  Details – Purchase »{' '}
