          ...
          <div>
            <div className='relative'>
              <a data-fancybox='gallery-f206' href='assets/images/img-01.webp'>
                <img alt='' src={`${process.env.NEXT_PUBLIC_SHOP_API_URL}/files/${item?.collectionName}/${item?.id}/${item?.decor[0]}`} />
              </a>
            ...
            <div className='relative border border-[#cccccc] px-7 py-6'>
              ...
              <div className='mt-3'>
                <div className='grid grid-cols-2 text-left'>
                  ...
                  <div className='text-lg text-primary'>{item?.length} x {item?.width} mm</div>
                </div>
                <div className='grid grid-cols-2 text-left'>
                  <div className='text-lg text-black'>Thickness: </div>
                  <div className='text-lg text-primary'>{thickness[0]?.thickness}, {thickness[1]?.thickness} mm</div>
                </div>
                <div className='grid grid-cols-2 text-left'>
