        ...
        <div className=' flex justify-center items-center flex-col'>
          <div className='text-center flex flex-col gap-3 max-w-[80%] text-black mb-5'>
            ...
            <p className='text-base text-black'>
              ...
              With an eye towards the natural world, there are various kinds of metals that represent aluminium, inox,
              and chrome, as well as stones like slate and marble. In terms of artificial materials, there are some
              incredibly beautiful textures that are reminiscent of concrete, fabric, and linen.
            </p>
            <p className='text-base text-black'>
              With a few exceptions, most colours are a little bit darker, which let you achieve a specific kind of
              sophistication—one that reflects light and gives the interior décor a more striking appearance. The
              material reproductions from Egger are designed to accomplish just that—and more—if you want to stand out
              from the crowd.
            </p>
