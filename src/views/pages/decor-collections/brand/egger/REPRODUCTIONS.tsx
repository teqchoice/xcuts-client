        ...
        <div className=' flex justify-center items-center flex-col'>
          <div className='text-center flex flex-col gap-3 max-w-[80%] text-black mb-5'>
            ...
            <p className='text-base text-black'>
              ...
              collection also includes some uncommon wood species like coco bolo, hickory, acacia and wenge. To enhance
              the natural aesthetic, every wood design has been finished in a variety of brown tones, so there is
