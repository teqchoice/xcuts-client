        ...
        <div className='px-4 sm:container'>
          <div className='text-center px-1 overflow-hidden'>
            ...
            <div className='flex flex-col gap-y-3 text-black-1d mt-10'>
              <p>
                At XCUTS, we provide precise cut-to-size boards to meet the growing needs of the building, furniture
                manufacturing, and interior design industries. We offer a wide range of plain and decorative boards,
                keeping up with the latest global design trends. Our on-site cutting service handles a variety of
                materials, including MDF, veneered, and melamine-faced chipboard (MFC).
              </p>
              <p>
                Whether you're a professional in need of custom panels or a DIY enthusiast tackling a home project,
                we’re here to help. Handling full-size MDF and MFC boards can be challenging without industrial
                machinery, and that's where our service excels. We cut with precision on all four sides to ensure clean
                edges and chip-free cuts on every subsequent cut.
              </p>
            </div>
