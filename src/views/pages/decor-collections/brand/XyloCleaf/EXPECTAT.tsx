        ...
        <div className=' flex justify-center items-center flex-col'>
          <div className='text-center flex flex-col gap-3 max-w-[80%] text-black mb-5'>
            ...
            <p className='text-base text-black'>
              ...
              for high-end interiors, they seamlessly blend sophistication with comfort, offering a unique texture that
              invites touch and admiration.
            </p>
          </div>
          ...
          <div className='text-center flex flex-col gap-3 max-w-[80%] text-black mb-5'>
            ...
            <p className='text-base text-black'>
              ...
              striking the perfect balance between raw aesthetics and contemporary elegance. Whether used in residential
              or commercial settings, they create striking visual statements while maintaining a sense of warmth and
              approachability.
            </p>
          </div>
          ...
          <div className='text-center flex flex-col gap-3 max-w-[80%] text-black mb-5'>
            ...
            <p className='text-base text-black'>
              ...
              ordinary spaces into extraordinary visual experiences. The interplay of geometry and aesthetics allows for
              innovative design possibilities, adding depth and dimension to any interior.
            </p>
          </div>
          ...
          <div className='text-center flex flex-col gap-3 max-w-[80%] text-black mb-5'>
            ...
            <p className='text-base text-black'>
              ...
              options and inspiring creative visions for your projects.
            </p>
          </div>
