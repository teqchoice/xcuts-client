        ...
        <div className='px-4 sm:container'>
          <div className='text-center text-white mb-11 relative'>
            ...
            <h4 className='lg:text-5xl md:text-3xl text-2xl font-semibold'>
              More Information Regarding Our CNC Cutting Service:
            </h4>
            <p className='mt-5'>
              Watch the CNC machine at Xcuts as it works on various projects. Using specialised software, our team of
              CNC designers first translates your ideas and specifications, simulates the cutting process, and then
              sends it to the CNC machine. The CNC operators set up the appropriate panels for work, choose the required
              project, and control the CNC machine to guarantee accurate cutting. The CNC operators straighten up the
              area and remove the cut panels once the project is finished, making it ready for the next one.
            </p>
          </div>
          <div
            className='embed-responsive pt-[55.5%] embed-responsive-16 by-9 relative w-full overflow-hidden rounded-md border-solid border-8 border-white'
          ...
          >
            ...
            <video
              className='embed-responsive-item absolute bottom-0 left-0 right-0 top-0 h-full w-full '
              src={props?.Data?.src ?? '/images/vid/Main Banner.mp4'}
              width='100%'
              height='auto'
              onMouseEnter={e => {
