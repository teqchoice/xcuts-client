          ...
          <div className='text-center px-1 overflow-hidden'>
            ...
            <div className='bg-black mx-6 md:mx-28 skew-y-[0] skew-x-[35deg] relative'>
              ...
              <h1 className='text-white text-xl/6 md:text-4xl font-bold -skew-x-[35deg] py-2 px-4'>
                A clean edge to provide a flawless finish.
              </h1>
            </div>
            <div className='flex flex-col gap-y-3 text-black-1d mt-10'>
              <p>
                Edgebanding is use to protect the bare edges after a panel has been cut, and to provide a seamless
                finish for edges that are exposed.
              </p>
              <p>
                Our edgebanding service for panels uses PUR glue, which is heated, applied to the edgebanding tape, and
                pressed together. After application, the edgebanding tape is trimmed to provide a radius, square, or
                bevel finish.
              </p>
              <p>
                Edgebanding tape can be matched to your panel, or an alternative tape can be used to provide a
                contrasting effect.
              </p>
            </div>
