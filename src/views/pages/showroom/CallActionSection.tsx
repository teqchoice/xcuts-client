  ...
  return (
    <section className='w-full bg-neutral-500'>
      <div className='px-4 sm:container'>
        <div className='planyourvisit bg-primary px-5 py-9 flex flex-col md:flex-row justify-between items-center -mt-16 relative'>
          <h5 className='font-semibold text-2xl text-white text-center md:text-left mb-8 md:mb-0'>
